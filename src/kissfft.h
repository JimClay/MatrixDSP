...
class kissfft
{
    public:
        ...
        void transform(ComplexIterator fft_in, ComplexIterator fft_out, const std::size_t stage = 0, const std::size_t fstride = 1, const std::size_t in_stride = 1) const
        {
        ...
        void transform_real( RealIterator const src, ComplexIterator const dst ) const
        {
